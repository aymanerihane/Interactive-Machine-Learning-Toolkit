...
class LineGraphs(BaseChart):  # Inherit from CTkFrame for a reusable widget
    def __init__(self, parent, switch_page,sharedState):
        super().__init__(parent, switch_page,sharedState, chart_type="Line Graphs", has_y_axis=True,no_x_y=False,just_num=True)
    ...
    def plot_chart(self):
        ...
        fig = visualizer.plot_line(self.selected_x_column,self.selected_y_column)
